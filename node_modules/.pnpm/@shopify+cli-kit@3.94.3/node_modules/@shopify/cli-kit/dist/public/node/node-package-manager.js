...
function normalizePackageManagerForProject(packageManager) {
...
function packageManagerBinaryCommand(packageManager, binary, ...binaryArgs) {
    switch (packageManager) {
        case 'npm':
...
export async function getPackageManager(fromDirectory) {
    ...
    const pm = packageManagerFromUserAgent();
    if (pm !== 'unknown')
        return pm;
    return 'npm';
}
 ...
 */
export async function packageManagerBinaryCommandForDirectory(fromDirectory, binary, ...binaryArgs) {
