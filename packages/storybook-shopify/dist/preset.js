...
existing = [], options) => {
    ...
    for (const dir of dirs) {
        ...
        for (const file of readdirSync(dirPath)) {
            if (!file.endsWith('.liquid') || shouldSkipLiquidFile(file))
                continue;
